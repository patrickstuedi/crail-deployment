...
./bin/spark-submit --master yarn --deploy-mode client --num-executors 8 --executor-cores 8 --executor-memory 48G --driver-memory 48G --class com.github.ehiggs.spark.terasort.TeraSort /home/ubuntu/crail-deployment/spark/apps/jars-ana/spark-terasort-1.0-jar-with-dependencies.jar data/terasort_in_6000g data/terasort_out_6000g

./bin/spark-submit --master yarn --deploy-mode client --num-executors 1 --executor-cores 8 --executor-memory 48G --driver-memory 48G --class com.github.ehiggs.spark.terasort.TeraSort /home/ubuntu/crail-deployment/spark/apps/jars-ana/spark-terasort-1.0-jar-with-dependencies.jar data/terasort_in_750g data/terasort_out_750g
