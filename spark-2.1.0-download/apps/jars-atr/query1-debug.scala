...
val tabName = RESULT_NAME
data.write.format("parquet").mode(SaveMode.Overwrite).save(RESULT_PATH + tabName)
println("Done writing to " + RESULT_PATH + RESULT_NAME)